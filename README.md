...
This repository contains source and build metadata only; runtime configuration and credentials are
provided by the deployment environment. See [`LICENSE`](./LICENSE) and
